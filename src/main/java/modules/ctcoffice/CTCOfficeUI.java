...
public class CTCOfficeUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SpeedLabel.setFont(new java.awt.Font("Segoe UI Light", 0, 18)); // NOI18N
        SpeedLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        SpeedLabel.setText("Speed");
        SpeedLabel.setEnabled(false);

        SpeedField.setFont(new java.awt.Font("Courier New", 0, 18)); // NOI18N
        ...
        AuthorityLabel.setFont(new java.awt.Font("Segoe UI Light", 0, 18)); // NOI18N
        AuthorityLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        AuthorityLabel.setText("Authority");
        AuthorityLabel.setEnabled(false);

        AuthorityField.setFont(new java.awt.Font("Courier New", 0, 18)); // NOI18N
        ...
        UpdateTrainButton.setFont(new java.awt.Font("Courier New", 0, 18)); // NOI18N
        UpdateTrainButton.setText("Update Train");
        UpdateTrainButton.setEnabled(false);
        ...
        javax.swing.GroupLayout UpdateTrainPanelLayout = new javax.swing.GroupLayout(UpdateTrainPanel);
        UpdateTrainPanel.setLayout(UpdateTrainPanelLayout);
        UpdateTrainPanelLayout.setHorizontalGroup(
            UpdateTrainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(UpdateTrainPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(UpdateTrainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(SpeedField)
                    .addComponent(UpdateTrainButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(ToggleEditButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        UpdateTrainPanelLayout.setVerticalGroup(
            UpdateTrainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(UpdateTrainPanelLayout.createSequentialGroup()
                .addContainerGap()
                ...
                .addGap(18, 18, 18)
                .addComponent(UpdateTrainButton)
        ...
        ActiveTrainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(ActiveTrainPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(UpdateTrainPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, ActiveTrainPanelLayout.createSequentialGroup()
                .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 293, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(ActiveSelectedTrainLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ActiveTrainPanelLayout.setVerticalGroup(
            ...
            .addGroup(ActiveTrainPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(ActiveTrainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void ActiveRedTableMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if (row > -1) {
            ...
            selected = Integer.parseInt(trainID);
    ...
    private void AuthorityFieldActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void ToggleEditButtonActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        if (ToggleEditButton.isSelected()) {
            AuthorityLabel.setEnabled(true);
            AuthorityField.setEnabled(true);
            SpeedLabel.setEnabled(true);
            SpeedField.setEnabled(true);
            UpdateTrainButton.setEnabled(true);
        } else {
            AuthorityLabel.setEnabled(false);
            AuthorityField.setEnabled(false);
            SpeedLabel.setEnabled(false);
